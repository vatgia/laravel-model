...
class Model extends LaravelModel
{
    ...
    public function setConnection($name = null)
    {
        ...
        if ($this->isEnableConnection($connection)) {
        ...
        if ($connections) {
            $connections = $this->getEnableConnections($connections);
    ...
    /**
     * Check connection is enable in config
     *
     * @param $connection
     * @return bool
     */
    protected function isEnableConnection($connection)
    {
     ...
     * @return array
     */
    protected function getEnableConnections($connections)
    {
        $result = [];
